...
perl -I $D/../lib $D/pspdb-generate-xml.pl --person-list "$PERSONLIST" "${PARAMS[@]}" --translations "$D/translations.unl" --output-dir "$OUTPUT_DIRECTORY" --input-db-dir "$OUTPUT_DIRECTORY" --debug
