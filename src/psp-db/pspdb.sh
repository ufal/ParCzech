...
usage() {
  echo -e "Usage: $0 -p PERSONLIST_FILE -o OUTPUT_DIRECTORY" 1>&2
  exit 1
}
...
perl -I $D/../lib $D/pspdb-generate-xml.pl --person-list "$PERSONLIST" --output-dir "$OUTPUT_DIRECTORY" --input-db-dir "$OUTPUT_DIRECTORY" --debug
